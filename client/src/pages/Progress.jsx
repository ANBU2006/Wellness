...
const Progress = () => {
    ...
    const findRecordForDate = (dateStr) => {
        return (history || []).find(h => new Date(h.date).toISOString().split('T')[0] === dateStr);
    };
    ...
    const fetchHistory = async () => {
        try {
            ...
            const sortedHistory = (res.data.history || []).sort((a, b) => new Date(a.date) - new Date(b.date));
        ...
        <div className="main-content">
            ...
            <div style={{
                ...
                <div style={{ position: 'relative' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                        <Activity size={18} color="rgba(255,255,255,0.8)" />
                        <span style={{ color: 'rgba(255,255,255,0.8)', fontWeight: 600, fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Health Analytics</span>
                    </div>
                    <h1 style={{ fontSize: '1.875rem', fontWeight: 800, color: 'white', marginBottom: '4px' }}>Pulse Analytics</h1>
                    <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '0.9rem' }}>Log your physical metrics and track your wellness trends.</p>
                </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '1.5rem' }}>
                ...
                <div style={{ gridColumn: 'span 8', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                    <div className="card" style={{ height: '320px', margin: 0 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ marginBottom: '1.5rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                                ...
                                <h2 style={{ fontSize: '1.05rem', fontWeight: 700 }}>Log Today's Status</h2>
                            </div>
                            <p style={{ color: '#94A3B8', fontSize: '0.85rem' }}>Record your physical metrics and last night's sleep.</p>
                        </div>

                        <form onSubmit={handleFormSubmit} style={{ display: 'grid', gap: '1rem' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>Date</label>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>Weight (kg)</label>
                                ...
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>Height (cm)</label>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>Sleep (Last Night)</label>
                                ...
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 700, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '6px' }}>Exercise (min)</label>
                            ...
                            {history.slice().reverse().map((h, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td style={{ padding: '0.875rem 1rem', color: '#334155' }}>{h.weight ? `${h.weight} kg` : <span style={{ color: '#CBD5E1' }}>—</span>}</td>
                                        <td style={{ padding: '0.875rem 1rem', color: '#334155' }}>{h.height ? `${h.height} cm` : <span style={{ color: '#CBD5E1' }}>—</span>}</td>
                                        ...
                                        <td style={{ padding: '0.875rem 1rem', color: '#334155' }}>{h.exerciseMinutes ? `${h.exerciseMinutes} min` : <span style={{ color: '#CBD5E1' }}>—</span>}</td>
